...
import 'package:wether_aplecerion/models/repository/next_second_repo.dart';
            ...
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Column(
                    children: [
                      Image.asset("assets/icons/ic_rain_snow.png",
                          height: 30, width: 30),
                      const SizedBox(height: 8),
                      const Text("10 C",
                          style: TextStyle(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Column(
                    children: [
                      Image.asset("assets/icons/ic_wint.png",
                          height: 30, width: 30),
                      const SizedBox(height: 8),
                      const Text("3 C",
                          style: TextStyle(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Column(
                    children: [
                      Image.asset("assets/icons/ic_thunder.png",
                          height: 30, width: 30),
                      const SizedBox(height: 8),
                      const Text("5 C",
                          style: TextStyle(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Column(
                    children: [
                      Image.asset("assets/icons/ic_cloude.png",
                          height: 30, width: 30),
                      const SizedBox(height: 8),
                      const Text("9 C",
                          style: TextStyle(
